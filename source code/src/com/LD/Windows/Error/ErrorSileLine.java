 ...
 * @author Mr-LiZhuo
 */
public class ErrorSileLine extends javax.swing.JFrame {

    ImageIcon error = new ImageIcon(ErrorSileLine.class.getResource("/com/LD/img/error.png"));
    ...
    public ErrorSileLine(String er) {
        this.er = er;
        initComponents();
    }

    public ErrorSileLine(String er, TheWay theway, int sa) {
        this.er = er;
        this.theway = theway;
        this.sa = sa;
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("invalid paramete: --siteline " + er);
